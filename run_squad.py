...
def train(args, train_dataset, model, tokenizer):
    ...
    for n, p in model.named_parameters():
        ...
        params_group['lr'] = args.learning_rate * \
                             (args.layerwise_lr_decay ** (model.config.num_hidden_layers - depth))
...
def main():
    ...
    parser.add_argument(
        "--output_dropout_prob", default=0.0, type=float, help="Dropout probability of output layer"
    )
    parser.add_argument(
        "--layerwise_lr_decay", default=1.0, type=float,
        help="Apply layerwise lr decay, i.e., shallower layers have lower learning rates"
    )
    parser.add_argument(
        "--max_steps",
        default=-1,
